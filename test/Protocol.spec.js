...
test('set', () => {
  ...
  expect(Protocol.set(b, 2, 42, 101, 102, 103, 104))
    .toEqual(Buffer.from([
      PLACEHOLDER, PLACEHOLDER,
      0x02, ...n.values(), 101, 102, 103, 104,
      PLACEHOLDER, PLACEHOLDER
    ]))

  n.writeUInt16LE(1000, 0)
  expect(Protocol.set(b, 2, 1000, 101, 102, 103, 104))
    .toEqual(Buffer.from([
      PLACEHOLDER, PLACEHOLDER,
      0x02, ...n.values(), 101, 102, 103, 104,
      PLACEHOLDER, PLACEHOLDER
...
test('fill', () => {
  ...
  expect(Protocol.fill(b, 2, 101, 102, 103, 104))
    .toEqual(Buffer.from([
      PLACEHOLDER, PLACEHOLDER,
      0x03, 0, 0, 101, 102, 103, 104,
      PLACEHOLDER, PLACEHOLDER
    ]))
})
...
test('in/outFrameSize', () => {
  ...
  expect(Protocol.outboundFrameSize()).toEqual(7)
  expect(Protocol.createOutboundFrame()).toEqual(Buffer.alloc(7, 0))
  expect(Protocol.createOutboundFrame(3)).toEqual(Buffer.alloc(7 * 3, 0))
})
